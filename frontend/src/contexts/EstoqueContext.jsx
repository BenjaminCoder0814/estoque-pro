...
const SEED_VERSION = 'v6'; // Incrementar aqui força reset do catálogo

const now = new Date().toISOString();
const prod = (id, nome, codigo, categoria, estoqueAtual, estoqueMinimo, geraAlerta, imagem) => ({
  id, nome, codigo, categoria, estoqueAtual, estoqueMinimo,
...
const produtosIniciais = [
  ...
  prod(13, 'Abraçadeira de Nylon Padrão',      'ABR-001', 'Abraçadeiras',  0, 50, true,  '/imagens/Abraçadeiras/Abraçadeira de Nylon — Padrão.png'),
  prod(14, 'Abraçadeira Identificável',        'ABR-002', 'Abraçadeiras',  0, 30, true,  '/imagens/Abraçadeiras/Abraçadeira Identificável.png'),
  prod(15, 'Abraçadeira Metálica',             'ABR-003', 'Abraçadeiras',  0, 20, true,  '/imagens/Abraçadeiras/Abraçadeira Metálica.png'),
  prod(16, 'ZFIX — Base Adesiva',             'ABR-004', 'Abraçadeiras',  0, 25, true,  '/imagens/Abraçadeiras/ZFIX — Base Adesiva.png'),
  ...
  // ── LACRES METÁLICOS ──
  prod(40, 'Lacre Metálico Amarelo',         'LMT-001', 'Lacres Metálicos',   0, 100, true,  '/imagens/Lacres metálicos/Amarelo 1.png'),
  prod(41, 'Lacre Metálico Azul',            'LMT-002', 'Lacres Metálicos',   0, 100, true,  '/imagens/Lacres metálicos/Azul 1.png'),
  prod(42, 'Lacre Metálico Vermelho',        'LMT-003', 'Lacres Metálicos',   0, 100, true,  '/imagens/Lacres metálicos/Vermelho 1.png'),
  prod(43, 'Lacre Chumbo Sinete',             'LMT-004', 'Lacres Metálicos',   0,  60, true,  '/imagens/Lacres metálicos/lacre-chumbo-sinete.png'),
  prod(44, 'Lacre Sextavado',                 'LMT-005', 'Lacres Metálicos',   0,  70, true,  '/imagens/Lacres metálicos/lacre-sextavado.png'),
  prod(45, 'Ajuste Caixa Ajustável',         'LMT-006', 'Lacres Metálicos',   0,  40, true,  '/imagens/Lacres metálicos/zajuste-caixa-ajustavel.png'),
  prod(46, 'Zlock 3 Folha Flandres',          'LMT-007', 'Lacres Metálicos',   0,  35, true,  '/imagens/Lacres metálicos/zlock-3-folha-flandres.png'),
  prod(47, 'Zlock Manivela',                  'LMT-008', 'Lacres Metálicos',   0,  30, true,  '/imagens/Lacres metálicos/zlock-manivela.png'),
  prod(48, 'Pino Bolt Seal',                  'LMT-009', 'Lacres Metálicos',   0,  50, true,  '/imagens/Lacres metálicos/zpino-bolt-seal.png'),

  // ── LACRES PLÁSTICOS ──
  prod(49, 'Lacre Âncora',                     'LPL-001', 'Lacres Plásticos',   0, 300, true,  '/imagens/Lacres Plásticos/ancora.png'),
  prod(50, 'Anel Extintor',                    'LPL-002', 'Lacres Plásticos',   0, 100, true,  '/imagens/Lacres Plásticos/anel-extintor.png'),
  prod(51, 'Aplicador para Lacre Sacola',      'LPL-003', 'Lacres Plásticos',   0,   3, true,  '/imagens/Lacres Plásticos/aplicador-lacre-sacola.png'),
  prod(52, 'Dupla Trava DT',                   'LPL-004', 'Lacres Plásticos',   0, 200, true,  '/imagens/Lacres Plásticos/dupla-trava-dt.png'),
  prod(53, 'Escada Alta ES',                   'LPL-005', 'Lacres Plásticos',   0, 150, true,  '/imagens/Lacres Plásticos/escada-alta-es.png'),
  prod(54, 'Espinha de Peixe',                 'LPL-006', 'Lacres Plásticos',   0, 100, true,  '/imagens/Lacres Plásticos/espinha-de-peixe.png'),
  prod(55, 'Lacre de Sacola — Zni',            'LPL-007', 'Lacres Plásticos',   0, 500, true,  '/imagens/Lacres Plásticos/Lacre de Sacola — Zni.png'),
  prod(56, 'Lacre para Caixas ALC',            'LPL-008', 'Lacres Plásticos',   0, 200, true,  '/imagens/Lacres Plásticos/lacre-caixas-alc.png'),
  prod(57, 'Lacre Tag Autenticidade',          'LPL-009', 'Lacres Plásticos',  10,  50, true,  '/imagens/Lacres Plásticos/lacre-tag-autenticidade.png'),
  prod(58, 'Lacre Pino Anel 25mm',             'LPL-009P','Lacres Plásticos',  17,  20, true,  '/imagens/Lacres Plásticos/ancora.png'),
  prod(59, 'Trava Anel',                       'LPL-010', 'Lacres Plásticos',   0, 150, true,  '/imagens/Lacres Plásticos/trava-anel.png'),
  prod(60, 'ZLS TM 35 — Trava Metálica',       'LPL-011', 'Lacres Plásticos',   0,  80, true,  '/imagens/Lacres Plásticos/ZLS TM 35 — Trava Metálica (TM).png'),

  // ── MALOTES, PASTAS E BOLSAS ── (qtd confirmada nas anotações de 29/12/25)
  prod(61, 'Bolsa com Zíper (Sacola)',          'MPB-001', 'Malotes, Pastas e Bolsas',   0,  5, true,  '/imagens/Malotes, pastas e bolsas/Bolsa com Zíper (estilo Sacola).png'),
  prod(62, 'Porta Sacola Supermercado',         'MPB-004', 'Malotes, Pastas e Bolsas',   0, 10, true,  '/imagens/Malotes, pastas e bolsas/Porta Sacola Supermercado.png'),
  prod(63, 'Sacola com Rodízio',                'MPB-005', 'Malotes, Pastas e Bolsas',   0,  5, true,  '/imagens/Malotes, pastas e bolsas/Sacola com Rodízio.png'),
  prod(64, 'Urna em Lona',                      'MPB-006', 'Malotes, Pastas e Bolsas',   0,  5, true,  '/imagens/Malotes, pastas e bolsas/Urna em Lona.png'),
  prod(65, 'Malote Correio 30x25x10 Marrom',    'MPB-M01', 'Malotes, Pastas e Bolsas',   1,  2, true,  '/imagens/Malotes, pastas e bolsas/Malote Correio.png'),
  prod(66, 'Malote Correio 56x36x10 Azul',      'MPB-M02', 'Malotes, Pastas e Bolsas',   5,  2, true,  '/imagens/Malotes, pastas e bolsas/Malote Correio.png'),
  prod(67, 'Malote Lona 52x34x17 Laranja',      'MPB-M03', 'Malotes, Pastas e Bolsas',   4,  2, true,  '/imagens/Malotes, pastas e bolsas/Malote Correio.png'),
  prod(68, 'Pasta Emborrachada 30x40 Azul',     'MPB-P01', 'Malotes, Pastas e Bolsas',  18,  5, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(69, 'Pasta Lona 30x40',                  'MPB-P02', 'Malotes, Pastas e Bolsas',   5,  3, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(70, 'Pasta Lona 40x35 c/ Visores Verde', 'MPB-P03', 'Malotes, Pastas e Bolsas',  13,  3, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(71, 'Pasta Lona 34x27 Verde',            'MPB-P04', 'Malotes, Pastas e Bolsas',  15,  3, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(72, 'Pasta Lona 40x35 Azul',             'MPB-P05', 'Malotes, Pastas e Bolsas',  21,  5, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(73, 'Pasta Lona 30x40 Visor Lateral Verde','MPB-P06','Malotes, Pastas e Bolsas',  3,  2, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(74, 'Pasta Lona 21x36 Preto',            'MPB-P07', 'Malotes, Pastas e Bolsas',  49,  5, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(75, 'Pasta Nylon 30x40',                 'MPB-P08', 'Malotes, Pastas e Bolsas',   6,  3, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(76, 'Pasta Nylon 29x39 Cinza',           'MPB-P09', 'Malotes, Pastas e Bolsas',   1,  2, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(77, 'Pasta Nylon 28x40 Verde',           'MPB-P10', 'Malotes, Pastas e Bolsas',   1,  2, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(78, 'Pasta Nylon 40x35x8',               'MPB-P11', 'Malotes, Pastas e Bolsas',   6,  3, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(79, 'Pasta Nylon 46x41x8 Vermelho',      'MPB-P12', 'Malotes, Pastas e Bolsas',   4,  2, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(80, 'Pasta Nylon 35x30 Azul',            'MPB-P13', 'Malotes, Pastas e Bolsas',  10,  3, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(81, 'Pasta 51x41x8 Verde',               'MPB-P14', 'Malotes, Pastas e Bolsas',   4,  2, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(82, 'Pasta 45x40x6 Verde',               'MPB-P15', 'Malotes, Pastas e Bolsas',   2,  2, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(83, 'Pasta 46x41 Verde',                 'MPB-P16', 'Malotes, Pastas e Bolsas',   1,  2, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(84, 'Pasta 17x26 sem Alça Preto',        'MPB-P17', 'Malotes, Pastas e Bolsas',   5,  2, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(85, 'Pasta 40x26 Preto',                 'MPB-P18', 'Malotes, Pastas e Bolsas',   4,  2, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(86, 'Pasta 30x40 Mix (Nylon/Emborrachada)','MPB-P19','Malotes, Pastas e Bolsas',  4,  2, true,  '/imagens/Malotes, pastas e bolsas/Pasta para Documentos.png'),
  prod(87, 'Bolsa Preta Lona 37x39x21',         'MPB-B01', 'Malotes, Pastas e Bolsas',   4,  2, true,  '/imagens/Malotes, pastas e bolsas/Bolsa com Zíper (estilo Sacola).png'),
  ...
  // ── MÁQUINAS ──
  prod(97,  'Máquina Lacradora Quadrada',       'MAQ-001', 'Máquinas',  72,  2, true,  '/imagens/Máquinas/Máquina lacradora quadrada.png'),
  prod(98,  'Máquina Lacradora Redonda',        'MAQ-002', 'Máquinas',  16,  2, true,  '/imagens/Máquinas/Máquina lacradora redonda.png'),
  prod(99,  'Máquina Seladora',                 'MAQ-003', 'Máquinas',   0,  1, true,  '/imagens/Máquinas/Máquina seladora.png'),
  prod(100, 'Refil de Selagem / Fios Etiqueta', 'MAQ-004', 'Máquinas',  12,  3, true,  '/imagens/Máquinas/Refil de selagem.png'),
