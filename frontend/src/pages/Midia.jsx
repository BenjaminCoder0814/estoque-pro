...
const FOTO_CATS = [
  ...
  },
  {
    ...
    fotos: [
      { nome: 'Abraçadeira Padrão',        url: '/imagens/abracadeiras/Abraçadeira de Nylon — Padrão.png' },
      { nome: 'Abraçadeira Identificável', url: '/imagens/abracadeiras/Abraçadeira Identificável.png' },
      { nome: 'Abraçadeira Metálica',      url: '/imagens/abracadeiras/Abraçadeira Metálica.png' },
      { nome: 'ZFIX — Base Adesiva',       url: '/imagens/abracadeiras/ZFIX — Base Adesiva.png' },
    ],
  },
  {
  ...
  },
  {
    ...
    fotos: [
      { nome: 'Lacre Amarelo 1',          url: '/imagens/lacres-metalicos/Amarelo 1.png' },
      { nome: 'Lacre Amarelo 2',          url: '/imagens/lacres-metalicos/Amarelo 2.png' },
      { nome: 'Lacre Amarelo 3',          url: '/imagens/lacres-metalicos/Amarelo 3.png' },
      { nome: 'Lacre Azul 1',             url: '/imagens/lacres-metalicos/Azul 1.png' },
      { nome: 'Lacre Azul 2',             url: '/imagens/lacres-metalicos/Azul 2.png' },
      { nome: 'Lacre Azul 3',             url: '/imagens/lacres-metalicos/Azul 3.png' },
      { nome: 'Lacre Azul 4',             url: '/imagens/lacres-metalicos/Azul 4.png' },
      { nome: 'Lacre Chumbo Sinete',      url: '/imagens/lacres-metalicos/lacre-chumbo-sinete.png' },
      { nome: 'Lacre Sextavado',          url: '/imagens/lacres-metalicos/lacre-sextavado.png' },
      { nome: 'Lacre Vermelho 1',         url: '/imagens/lacres-metalicos/Vermelho 1.png' },
  ...
  },
  {
    ...
    fotos: [
      { nome: 'Âncora',                   url: '/imagens/lacres-plasticos/ancora.png' },
      { nome: 'Anel Extintor',            url: '/imagens/lacres-plasticos/anel-extintor.png' },
      { nome: 'Aplicador Lacre Sacola',   url: '/imagens/lacres-plasticos/aplicador-lacre-sacola.png' },
      { nome: 'Dupla Trava DT',           url: '/imagens/lacres-plasticos/dupla-trava-dt.png' },
      { nome: 'Escada Alta ES',           url: '/imagens/lacres-plasticos/escada-alta-es.png' },
      { nome: 'Espinha de Peixe',         url: '/imagens/lacres-plasticos/espinha-de-peixe.png' },
      { nome: 'Lacre de Sacola ZNI',      url: '/imagens/lacres-plasticos/Lacre de Sacola — Zni.png' },
      { nome: 'Lacre Caixas ALC',         url: '/imagens/lacres-plasticos/lacre-caixas-alc.png' },
      { nome: 'Lacre TAG Autenticidade',  url: '/imagens/lacres-plasticos/lacre-tag-autenticidade.png' },
      { nome: 'Trava Anel',               url: '/imagens/lacres-plasticos/trava-anel.png' },
      { nome: 'ZLS TM 35 — Trava Metálica', url: '/imagens/lacres-plasticos/ZLS TM 35 — Trava Metálica (TM).png' },
    ],
  },
  {
    ...
    fotos: [
      { nome: 'Bolsa com Zíper',          url: '/imagens/malotes/Bolsa com Zíper (estilo Sacola).png' },
      { nome: 'Malote Correio',           url: '/imagens/malotes/Malote Correio.png' },
      { nome: 'Pasta para Documentos',    url: '/imagens/malotes/Pasta para Documentos.png' },
      { nome: 'Porta Sacola Supermercado',url: '/imagens/malotes/Porta Sacola Supermercado.png' },
      { nome: 'Sacola com Rodízio',        url: '/imagens/malotes/Sacola com Rodízio.png' },
      { nome: 'Sacola com Rodízio 1',     url: '/imagens/malotes/Sacola com Rodízio 1.png' },
      { nome: 'Urna em Lona',             url: '/imagens/malotes/Urna em Lona.png' },
    ],
  },
  {
    ...
    fotos: [
      { nome: 'Máquina Lacradora Quadrada', url: '/imagens/maquinas/Máquina lacradora quadrada.png' },
      { nome: 'Máquina Lacradora Redonda',  url: '/imagens/maquinas/Máquina lacradora redonda.png' },
      { nome: 'Máquina Seladora',           url: '/imagens/maquinas/Máquina seladora.png' },
      { nome: 'Refil de Selagem',           url: '/imagens/maquinas/Refil de selagem.png' },
    ],
  },
];
